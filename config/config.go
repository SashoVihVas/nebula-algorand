...
func ConfigureNetwork(network string) (*cli.StringSlice, *cli.StringSlice, error) {
	...
	case NetworkAlgoTestnet:
		...
		protocols = cli.NewStringSlice("/algorand-ws/2.2.0", "/algorand/kad/testnet/kad/1.0.0")
	case NetworkAlgoMainnet:
		bootstrapPeers = cli.NewStringSlice(BootstrapPeersAlgoMainnet...)
		protocols = cli.NewStringSlice("/algorand-ws/2.2.0", "/algorand/kad/mainnet/kad/1.0.0")
	default:
